...
<body>
    ...
    <nav class="bg-yl py-4 flex flex-row justify-between px-4 items-center drop-shadow-lg">
        ...
        <div class="flex flex-row items-center gap-2 hover:cursor-pointer hover:translate-y-[10px] transition-all ease-in-out duration-200 group">
            ...
            <h1 class="xxs:text-xs xl:text-lg font-semibold bg-bl rounded-lg xxs:px-2 xxs:py-1 md:px-4 md:py-2 shadow-keycaps-bl border-2 border-gray-800 group-hover:shadow-active-bl transition-all ease-in-out duration-200 font-sourGummy"><span class="text-gray-900 font-bold xxs:text-sm md:text-xl font-passionate">CodeX</span> Solutions</h1>
        </div>

        <!-- menu -->
        <div id="menu-item" class="xxs:hidden md:flex flex gap-4">
            <a href="#" class="border-2 border-transparent underline-offset-4 hover:underline hover:text-slate-400 font-sourGummy duration-200 transition-all ease-in-out">Home</a>
            <a href="#" class="border-2 border-transparent underline-offset-4 hover:underline hover:text-slate-400 font-sourGummy duration-200 transition-all ease-in-out">Services</a>
            <a href="#" class="border-2 border-transparent underline-offset-4 hover:underline hover:text-slate-400 font-sourGummy duration-200 transition-all ease-in-out">Testimonial</a>
            <a href="#" class="border-2 border-transparent underline-offset-4 hover:underline hover:text-slate-400 font-sourGummy duration-200 transition-all ease-in-out">Contact</a>
        </div>
        ...
        <div class="bg-bl md:border-2 shadow-keycaps-bl md:border-gray-700 rounded-xl font-semibold xxs:border-0 xxs:px-0 xxs:py-0 md:px-6 md:py-2 text-black transform hover:translate-y-[10px] hover:text-gray-700 hover:shadow-active-bl transition-all duration-200 ease-in-out">
            <a href="#" class="xxs:hidden md:flex font-sourGummy">Log In</a>
    ...
    <div id="sidebar" class="h-screen w-64 bg-yl text-gray-700 border-r-2 border-gray-700 fixed left-0 top-0 -translate-x-full transform transition-transform duration-300 z-50">
        <div class="p-4">
            ...
            <nav class="mt-8">
                <ul>
                    <li class="mb-4 bg-bl rounded-lg shadow-keycaps-bl border-2 border-gray-700 hover:translate-y-[10px] hover:shadow-active-bl transition-all duration-200 ease-in-out">
    ...
    <main>
                    ...
                    <div class="bg-white inline-flex shadow-2xl hover:shadow-lg flex-col p-4 rounded-lg border-2 border-black hover:scale-110 transition-transform duration-200 ease-in-out transform group-hover:translate-x-44 mb-4">
                        ...
                        <div>
                            ...
                            <div class="py-4 flex flex-row justify-around items-center">
                                ...
                                <button class="bg-bl shadow-keycaps-bl border-2 border-black py-2 px-4 rounded-lg hover:text-text-gray-800 hover:translate-y-[10px] hover:shadow-active-bl font-sourGummy transition-all duration-200 ease-in-out">Order now</button>
                            </div>
                        </div>
                    </div>
        ...
        <div class="flex flex-col justify-center items-center gap-4 p-6">
            ...
            <div class="flex flex-col xxs:gap-4 sm:gap-4 md:flex-row md:gap-6 xl:gap-9">
                ...
                <!-- UI/UX Card -->
                <div class="bg-bl font-sourGummy shadow-keycaps-bl p-4 rounded-lg justify-evenly xxs:scale-75 sm:scale-75 md:scale-100 inline-flex flex-col h-64 w-64 drop-shadow-2xl border-2 border-gray-700 transform xxs:hover:scale-90 md:hover:scale-105 hover:border-3 hover:shadow-none transition-all duration-200 ease-in-out">
                ...
                <div class="bg-pk font-sourGummy shadow-keycaps-pk p-4 rounded-lg justify-evenly xxs:scale-75 sm:scale-75 md:scale-100 inline-flex flex-col h-64 w-64 gap-6 drop-shadow-2xl border-2 border-gray-700 transform xxs:hover:scale-90 md:hover:scale-105 hover:border-3 hover:shadow-none transition-all duration-200 ease-in-out">
                ...
                <!-- IT Support Card -->
                <div class="bg-yl font-sourGummy shadow-keycaps-yl p-4 rounded-lg justify-evenly xxs:scale-75 sm:scale-75 md:scale-100 inline-flex flex-col h-64 w-64 gap-6 drop-shadow-2xl border-2 border-gray-700 transform xxs:hover:scale-90 md:hover:scale-105 hover:border-3 hover:shadow-none transition-all duration-200 ease-in-out">
        ...
        <div class="flex flex-row bg-red-500">
            ...
            <div class="xxs:flex xxs:flex-col xxs:justify-evenly xxs:w-full xxs:h-96 md:w-1/2 md:h-96 md:flex-col bg-yl md:p-6 md:justify-around">
                ...
                <div class="flex justify-evenly gap-4">
                    <div class="bg-[#ABDAFC] drop-shadow-md inline-flex xxs:w-32 xxs:h-40 md:w-40 md:h-40 p-6 flex-col text-center rounded-lg border-2 border-gray-700 shadow-keycaps-bl hover:shadow-active-bl hover:translate-y-[10px] transition-all ease-in-out">
                        <h1 class="underline underline-offset-4 font-bold font-sourGummy text-slate-900">200+</h1>
                        <p class="xxs:text-xs font-light text-slate-900 font-sourGummy">Kami sudah melayani lebih dari 200+ Client</p>
                    </div>
                    <div class="bg-[#F88DAD] drop-shadow-md inline-flex xxs:w-32 xxs:h-40 md:w-40 md:h-40 p-6 flex-col text-center rounded-lg border-2 border-gray-700 shadow-keycaps-pk hover:shadow-active-pk hover:translate-y-[10px] transition-all ease-in-out">
                        <h1 class="underline underline-offset-4 font-bold font-sourGummy text-slate-900">75+</h1>
                        <p class="xxs:text-xs font-light text-slate-900 font-sourGummy">Kami telah menyelesaikan lebih dari 75+ Project</p>
                    </div>
                    <div class="bg-[#FAC748] drop-shadow-md inline-flex xxs:w-32 xxs:h-40 md:w-40 md:h-40 p-6 flex-col text-center rounded-lg border-2 border-gray-700 shadow-keycaps-yl hover:shadow-active-yl hover:translate-y-[10px] transition-all ease-in-out">
                        <h1 class="underline underline-offset-4 font-bold font-sourGummy text-slate-900">175+</h1>
                        <p class="xxs:text-xs font-light text-slate-900 font-sourGummy">Kami telah mendapat 275 Review Positive</p>
                    </div>
                </div>
        ...
        <div class="bg-transparentw-full flex justify-center">
            ...
            <div class="bg-yl w-[80%] rounded-xl p-4 flex flex-row justify-between items-center drop-shadow-lg">
                <h1 class="text-gray-700 font-sourGummy">Siap untuk memulai? </h1>
                <button class="font-sourGummy bg-bl px-12 py-2 rounded-xl border-2 shadow-keycaps-bl text-black border-gray-700 hover:shadow-active-bl hover:text-gray-700 hover:translate-y-[10px] transition-all ease-in-out duration-200">Start</button>
            </div>
            ...
            <div class="flex items-center justify-center min-h-screen bg-gray-100">
                <div class="w-full max-w-lg p-8 bg-yl border-8 border-ylb rounded-xl shadow-md">
                    ...
                    <form action="#" method="POST" class="space-y-4">
                        ...
                        <!-- Tombol Submit -->
                        <div class="text-center">
                            <button type="submit" class="px-6 py-2 font-sourGummy text-black bg-bl shadow-keycaps-bl border-2 border-gray-700 rounded-lg hover:shadow-active-bl hover:text-gray-700 transform hover:translate-y-[10px] focus:ring-4 focus:ring-blue-300 transition-all duration-200 ease-in-out">Send an email</button>
                        </div>
                    </form>
                </div>
            </div>
